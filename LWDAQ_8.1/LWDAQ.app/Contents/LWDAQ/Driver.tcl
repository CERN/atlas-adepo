...
#
# LWDAQ_flash_seconds tells a driver at the other end of
# $sock to flash a source for $value seconds. The driver will 
# be busy for $value seconds after it receives the delay 
# instructions. If the delay is larger than the max_delay_seconds,
# the routine submits multiple flash jobs to create a total delay 
# of $value seconds.
#
