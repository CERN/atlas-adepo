...
# installed.
TCL_PREFIX='F:/Scratch'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='F:/Scratch'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/e/Home/dbn/lba/night/builds/win32-ix86/tcl/win/win32-ix86 -ltcl85'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-LF:/Scratch/lib -ltcl85'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IF:/Scratch/include'
...
# compiled.
TCL_SRC_DIR='/e/Home/dbn/lba/night/builds/win32-ix86/tcl'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='F:/Scratch/lib F:/Scratch/lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/e/Home/dbn/lba/night/builds/win32-ix86/tcl/win/win32-ix86 -ltclstub85'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LF:/Scratch/lib -ltclstub85'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/e/Home/dbn/lba/night/builds/win32-ix86/tcl/win/win32-ix86/tclstub85.lib'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='F:/Scratch/lib/tclstub85.lib'
