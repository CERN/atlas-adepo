...
proc LWDAQ_init {} {
	...
	if {$info(slave_console)} {
		console title "TCL/TK Console for LWDAQ $info(program_patchlevel) on $info(os)"
	}
	...
	load [file join $info(lib_dir) lwdaq.so_$info(os)\_$info(arch)]
