...
proc LWDAQ_about {} {
	...
	label $w.l -text "$info(program_name) Version $info(program_patchlevel)\n \
		Running in TCL/TK $info(tcl_version) on $info(os) as $info(arch).\n \
		Distributed under GNU Public License.\n \
		Copyright 2003-2013, Kevan Hashemi, Brandeis University.\n \
		Copyright 2006-2013, Kevan Hashemi, Open Source Instruments.\n \
