...
# For full support for tool Help and Data, which we extract from the script
# files, make sure the tool script is in the Tools or Tools/More directory.
#
...
proc LWDAQ_tool_configure {name} {
	...
	foreach i $config_list {
		...
		entry $w.$f.e$i -textvariable $info(name)_config($i) \
