...
#
# RCS: @(#) $Id: init.tcl,v 1.104.2.12 2009/04/10 16:54:51 dgp Exp $
#
...
#
# Extension code to tcl8.5/library/init.tcl declaring the
# version information for ActiveTcl.
#
# ActiveState ActiveTcl 8.5.7.0.290198 Linux/x86, Thu Apr 16 21:43:15 PDT 2009
#
...
namespace eval ::activestate {
	...
	maturity      {final}
	arch          {linux-ix86}
	buildtime,sec {1239943395}
	buildtime,fmt {Thu Apr 16 21:43:15 PDT 2009}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.5.7.0.290198 Linux/x86 @ Thu Apr 16 21:43:15 PDT 2009 / normal}
    }
}

package provide {ActiveTcl} {8.5.7.0.290198}
