...
#
# RCS: @(#) $Id: init.tcl,v 1.102 2008/02/04 17:29:11 dgp Exp $
#
...
#
# ActiveState ActiveTcl 8.5.1.0.284069 Win32/x86, Mon Feb 04 20:37:54 PST 2008
#
...
namespace eval ::activestate {
	...
	maturity      {final}
	arch          {win32-ix86}
	buildtime,sec {1202186274}
	buildtime,fmt {Mon Feb 04 20:37:54 PST 2008}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.5.1.0.284069 Win32/x86 @ Mon Feb 04 20:37:54 PST 2008 / normal}
    }
}

package provide {ActiveTcl} {8.5.1.0.284069}
