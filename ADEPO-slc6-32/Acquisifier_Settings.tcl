...
set Acquisifier_config(daq_script) "/det/ti/PosMov/git/atlas-adepo/ADEPO-slc6-32/Acquisifier_Script.tcl" 
set Acquisifier_config(run_results) "/det/ti/PosMov/git/atlas-adepo/ADEPO-slc6-32/Acquisifier_Results.txt" 
